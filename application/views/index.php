    ...
    <main>
        ...
        <div class="slider-area ">
            <div class="slider-active">
                <div class="single-slider  hero-overly slider-height d-flex align-items-center" data-background="<?php echo base_url('assets/'); ?>img/hero/h1_hero.jpg">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-11">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="single-service-cap mb-30">
                            <div class="service-img">
                                <img src="<?php echo base_url('assets/'); ?>img/service/servicess1.png" alt="">
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="single-service-cap mb-30">
                            <div class="service-img">
                                <img src="<?php echo base_url('assets/'); ?>img/service/servicess2.png" alt="">
                            </div>
                            <div class="service-cap">
                                <h4><a href="services_details.html">Engineering techniques & implementation</a></h4>
                                <a href="services_details.html" class="more-btn">Read More <i class="ti-plus"></i></a>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="single-service-cap mb-30">
                            <div class="service-img">
                                <img src="<?php echo base_url('assets/'); ?>img/service/servicess3.png" alt="">
                            </div>
                            <div class="service-cap">
        ...
        <section class="support-company-area fix pt-10">
            <div class="support-wrapper align-items-end">
                ...
                <div class="right-content">
                    <!-- img -->
                    <div class="right-img">
                        <img src="<?php echo base_url('assets/'); ?>img/gallery/safe_in.png" alt="">
                    </div>
                            ...
                            <div class="single-testimonial">
                                ...
                                <div class="testimonial-caption ">
                                    <div class="testimonial-top-cap">
                                        ...
                                        <p>Mollit anim laborum.Dvcuis aute iruxvfg dhjkolohr in re voluptate velit esscillumlore eu quife nrulla parihatur. Excghcepteur sfwsignjnt occa cupidatat non aute iruxvfg dhjinulpadeserunt mollitemnth incididbnt ut;o5tu
                                            layjobore mofllit anim. Mollit anim laborum.Dvcuis aute iruxvfg dhjkolohr in re voluptate velit esscillumlore eu quife nrulla parihatur. Excghcepteur sfwsignjn.</p>
                                    </div>
                                    <!-- founder -->

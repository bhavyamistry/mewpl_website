                            ...
                            <div class="properties__button">
                                ...
                                <nav>
                                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                        <a class="nav-item nav-link active" id="nav-home-tab" href="<?php echo base_url('products'); ?>/General_purpose_fet" role="tab" aria-controls="nav-home" style="font-size:22px;color:#FFCC2A;" aria-selected="false">Catalog</a>
                                    </div>
                                </nav>
                                <!--End Nav Button  -->
                            </div>
